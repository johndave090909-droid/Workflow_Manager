  ...
  if (window.location.pathname === '/chat') {
    ...
    return (
      <div className="h-screen w-screen bg-[#0a0510] flex flex-col">
        <header className="h-14 flex items-center justify-between px-4 border-b border-white/10 bg-[#12091e] shrink-0">
          <div className="flex items-center gap-3">
            <button onClick={() => window.history.back()} className="p-2 rounded-xl text-slate-400 hover:text-white hover:bg-white/5 transition-colors">
            ...
            <span className="text-white font-black text-base tracking-tight">PCC Chat</span>
          </div>
        </header>
        <div className="flex-1 overflow-hidden">
          <MessengerPanel currentUser={currentUser} standalone />
        </div>
      </div>
    );
  }
