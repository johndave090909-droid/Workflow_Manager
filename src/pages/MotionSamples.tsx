...
const SAMPLES: Sample[] = [
  {
    ...
    color: '#e8891e',
    path: '/animations/samples/01/index.html',
  },
  {
    num: '02',
    title: '3D Model',
    desc: 'Interactive GLB viewer with orbit controls, gentle auto-rotate, and cinematic lighting.',
    tags: ['three.js', 'GLTFLoader', 'orbit', 'auto-rotate'],
    color: '#48d1c8',
    path: '/animations/samples/02/index.html',
  },
  {
    num: '03',
